...
const loadModules = () => Loader.loadModules(['esri/widgets/Sketch/SketchViewModel', 'esri/layers/GraphicsLayer', 'esri/Graphic']); // point | multipoint | polyline | polygon | circle | rectangle | move | transform | reshape
