...
function (_Component) {
  ...
  function BaseMapSelector(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BaseMapSelector).call(this, props));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMenuClick", function (_ref) {
      var key = _ref.key;
