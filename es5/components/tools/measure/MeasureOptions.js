...
function (_Component) {
  ...
  function MeasureOptionsBar(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MeasureOptionsBar).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "redoHandler", function () {
