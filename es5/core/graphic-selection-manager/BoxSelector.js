...
var BoxSelector = /*#__PURE__*/function (_BaseSelector) {
  _inherits(BoxSelector, _BaseSelector);

  var _super = _createSuper(BoxSelector);
  ...
  function BoxSelector(args) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_dragHandler", function (e) {
      e.stopPropagation();
    ...
    _defineProperty(_assertThisInitialized(_this), "_dragStartHandler", function (e) {
      e.stopPropagation();
    ...
    _defineProperty(_assertThisInitialized(_this), "_dragUpdateHandler", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_dragEndHandler", function (e) {
